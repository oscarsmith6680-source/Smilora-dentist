...
export const servicesCatalog = [
  {
    ...
    metaDescription:
      'Dental exams, professional cleans, X-rays, fluoride and sealants at Oralsquad — Melbourne preventive care for every age.',
    tagline: 'Catch problems early — most major dental work is avoidable with the right rhythm of visits.',
    overview:
      'Preventive dentistry at Oralsquad is built around your risk profile. We chart your gums, check each tooth for early decay, remove calculus that brushing cannot reach, and show you exactly where your brush and floss are missing — so your home care actually matches your mouth.',
    overviewExtra:
  ...
  },
  {
    ...
    metaDescription:
      'Professional teeth whitening at Oralsquad — safe, dentist-supervised whitening for a brighter smile in Melbourne.',
